...
function CookiePolicy () {
    return (
        ...
        <div className="container">
          <NavBarTop />
          <div className="row mt-5 cookie-container">
            <div className="col-lg-12">
              <h1 className="cookie-title text-center">Cookie Policy for UiRoute</h1>
              <p className="text-center cookie-subtitle">This is the Cookie Policy for UiRoute, accessible from uiroute.com</p>
              ...
              <ul>
                <li>Email: contact@uiroute.com</li>
              </ul>
            </div>
          </div>
        </div>
