export const productData = [
    ...
    {
        title: "Misiunea printre refugiați, evrei și rromi în Sud-Estul României",
        category: "Ui Kits",
        link: "/",
        style: {
            backgroundColor: "rgb(255, 255, 255)"
    ...
    {
        title: "Misiunea printre persoanele secularizate și printre cei cu obiceiuri idolatre din Oltenia",
        category: "Templates",
        link: "/",
        style: {
            backgroundColor: "rgb(255, 255, 255)"
    ...
    {
        title: "Instruirea potențialilor misionari străini și români",
        category: "Templates",
        link: "/",
        style: {
            backgroundColor: "rgb(255, 255, 255)"
        },
        description: "Programul nostru de instruire (MDT) este unul dintre cele mai importante lucrări de instruire în misiune, din această parte a Europei. În parteneriat cu OM Moldova instruim tineri romani și străini pentru lucrarea de misiune din Romania și de peste hotare. Însă, așa cum este lesne de înțeles, instruirea unui misionar, care este implicat total timp de 6 luni în această formă de instruire, este costisitoare și necesită foarte multă muncă și resurse diverse. Pentru un singur misionar este nevoie de 4000 Euro. Însă, așa cum vă puteți imagina, câștigul pentru Împărăția lui Dumnezeu, prin lucrarea acestor tineri, este incomensurabil.",
    },
    ...
    {
        title: "Misiune de susținere administrativă a organizației OM din Ghimbav",
        category: "Templates",
        link: "/",
        style: {
            backgroundColor: "rgb(255, 255, 255)"
